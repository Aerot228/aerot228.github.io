...
let todos = [{ id: 1, text: 'task 1', check: true }, { id: 2, text: 'task 2', check: false }, { id: 3, text: 'task 3', check: true }];
let id = 0;
if (todos.length != 0) {
    render();
}
...
function render() {
    ...
    todos.map(renderTodo).forEach(todo => localStorage.setItem(todo,todo.text));
